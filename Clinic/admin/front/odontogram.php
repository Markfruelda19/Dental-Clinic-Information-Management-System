...
<body>
        ...
        <div class="left-column">
            <div class="chart-container">
                <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px"
                    y="0px" viewBox="0 0 450 700" enable-background="new 0 0 450 700" xml:space="preserve">
                    <g id="toothLabels">
                        <text id="lbl32" transform="matrix(1 0 0 1 97.9767 402.1409)" font-family="'Avenir-Heavy'"
                            font-size="21px">32</text>
                        <text id="lbl31" transform="matrix(1 0 0 1 94.7426 449.1693)" font-family="'Avenir-Heavy'"
                            font-size="21px">31</text>
                        <text id="lbl30" transform="matrix(1 0 0 1 106.0002 495.5433)" font-family="'Avenir-Heavy'"
                            font-size="21px">30</text>
                        <text id="lbl29" transform="matrix(1 0 0 1 118.0002 538.667)" font-family="'Avenir-Heavy'"
                            font-size="21px">29</text>
                        <text id="lbl28" transform="matrix(0.9999 -1.456241e-02 1.456241e-02 0.9999 136.4086 573.5098)"
                            font-family="'Avenir-Heavy'" font-size="21px">28</text>
                        <text id="lbl27" transform="matrix(1 0 0 1 157.3335 603.8164)" font-family="'Avenir-Heavy'"
                            font-size="17px">27</text>
                        <text id="lbl26" transform="matrix(1 0 0 1 179.3335 623.8164)" font-family="'Avenir-Heavy'"
                            font-size="18px">26</text>
                        <text id="lbl25" transform="matrix(1 0 0 1 204.6669 628.483)" font-family="'Avenir-Heavy'"
                            font-size="18px">25</text>
                        <text id="lbl24" transform="matrix(1 0 0 1 231.3335 628.1497)" font-family="'Avenir-Heavy'"
                            font-size="18px">24</text>
                        <text id="lbl23" transform="matrix(1 0 0 1 256.3335 619.1497)" font-family="'Avenir-Heavy'"
                            font-size="17px">23</text>
                        <text id="lbl22" transform="matrix(1 0 0 1 276.3335 602.483)" font-family="'Avenir-Heavy'"
                            font-size="18px">22</text>
                        <text id="lbl21" transform="matrix(1 0 0 1 286.6669 573.1497)" font-family="'Avenir-Heavy'"
                            font-size="21px">21</text>
                        <text id="lbl20" transform="matrix(1 0 0 1 303.6327 538.667)" font-family="'Avenir-Heavy'"
                            font-size="21px">20</text>
                        <text id="lbl19" transform="matrix(1 0 0 1 322.983 495.5432)" font-family="'Avenir-Heavy'"
                            font-size="21px">19</text>
                        <text id="lbl18" transform="matrix(1 0 0 1 325.1251 449.1686)" font-family="'Avenir-Heavy'"
                            font-size="21px">18</text>
                        <text id="lbl17" transform="matrix(1 0 0 1 324.0004 402.1405)" font-family="'Avenir-Heavy'"
                            font-size="21px">17</text>
                        <text id="lbl16" transform="matrix(1 0 0 1 312.8534 324.1021)" font-family="'Avenir-Heavy'"
                            font-size="21px">16</text>
                        <text id="lbl15" transform="matrix(1 0 0 1 315.3335 275.3333)" font-family="'Avenir-Heavy'"
                            font-size="21px">15</text>
                        <text id="lbl14" transform="matrix(1 0 0 1 311.3335 236)" font-family="'Avenir-Heavy'"
                            font-size="21px">14</text>
                        <text id="lbl13" transform="matrix(1 0 0 1 300.3335 200.6667)" font-family="'Avenir-Heavy'"
                            font-size="21px">13</text>
                        <text id="lbl12" transform="matrix(1 0 0 1 286.6669 172)" font-family="'Avenir-Heavy'"
                            font-size="21px">12</text>
                        <text id="lbl11" transform="matrix(1 0 0 1 270.2269 142.439)" font-family="'Avenir-Heavy'"
                            font-size="21px">11</text>
                        <text id="lbl10" transform="matrix(1 0 0 1 247.5099 118.9722)" font-family="'Avenir-Heavy'"
                            font-size="21px">10</text>
                        <text id="lbl9" transform="matrix(1 0 0 1 227.8432 112.9722)" font-family="'Avenir-Heavy'"
                            font-size="21px">9</text>
                        <text id="lbl8" transform="matrix(1 0 0 1 200.1766 112.9722)" font-family="'Avenir-Heavy'"
                            font-size="21px">8</text>
                        <text id="lbl7" transform="matrix(1 0 0 1 170.5099 117.6388)" font-family="'Avenir-Heavy'"
                            font-size="21px">7</text>
                        <text id="lbl6" transform="matrix(1 0 0 1 148.6667 134.167)" font-family="'Avenir-Heavy'"
                            font-size="21px">6</text>
                        <text id="lbl5" transform="matrix(1 0 0 1 131.3605 164.8335)" font-family="'Avenir-Heavy'"
                            font-size="21px">5</text>
                        <text id="lbl4" transform="matrix(1 0 0 1 119.3927 195.6387)" font-family="'Avenir-Heavy'"
                            font-size="21px">4</text>
                        <text id="lbl3" transform="matrix(1 0 0 1 103.8631 234.4391)" font-family="'Avenir-Heavy'"
                            font-size="21px">3</text>
                        <text id="lbl2" transform="matrix(1 0 0 1 96.2504 275.9999)" font-family="'Avenir-Heavy'"
                            font-size="21px">2</text>
                        <text id="lbl1" transform="matrix(1 0 0 1 93.9767 324.769)" font-family="'Avenir-Heavy'"
                            font-size="21px">1</text>
                    </g>
                    <g id="dmftLabels">
                        <text id="txtTooth32" transform="matrix(1 0 0 1 5.0001 386.3778)"
                            font-family="'MyriadPro-Regular'"></text>
            ...
            <div class="info-history-wrapper">
                <div id="toothInfo">
                    <h3>TOOTH INFORMATION</h3>
                    <p>Click on a tooth to see its information and treatment history.</p>
                </div>
        ...
        <div class="right-column">
            ...
            <form id="treatmentForm" class="treatment-form">
                <input type="hidden" id="patient_id" name="patient_id"
                    value="<?php echo htmlspecialchars($_SESSION['current_patient_id'] ?? ''); ?>">
                <div class="form-group">
                    <label for="toothNumber">TOOTH NUMBER</label>
                    <input type="text" id="toothNumber" name="toothNumber" required>
                </div>
                <div class="form-group">
                    <label for="treatment">TREATMENT</label>
                    <select id="treatment" name="treatment" required onchange="showOtherInput()">
                        <option value="Dental Consultation">Dental Consultation</option>
                        <option value="Oral Prophylaxis">Oral Prophylaxis (Cleaning)</option>
                        <option value="Tooth Restoration">Tooth Restoration (Pasta)</option>
                        <option value="Tooth Extraction">Tooth Extraction (Bunot)</option>
                        <option value="Dentures (Complete Set)">Dentures (Pustiso)</option>
                        <option value="Dental Braces Package">Dental Braces</option>
                        <option value="Jacket Crown">Jacket Crown</option>
                        <option value="Fixed Bridge">Fixed Bridge</option>
                        <option value="Veeners">Veneers</option>
                    </select>
                </div>

                <div class="form-group" id="other-treatment-group" style="display: none;">
                    <label for="other-treatment">PLEASE SPECIFY</label>
                    <input type="text" id="other-treatment" name="other_treatment">
                </div>
    ...
    <select id="status" name="status" required>
        ...
        <option value="Jacket Crown">Crown</option>
        <option value="Missing">Missing</option>
        <option value="Under Treatment">Under Treatment</option>
        <option value="Restored">Restored</option>
        <option value="Infected">Infected</option>
        <option value="Requiring Extraction">Requiring Extraction</option>
    </select>
</div>
<div class="form-group">
    ...
    <select id="progress" name="progress" required>
        ...
        <option value="Canceled">Canceled</option>
            ...
            <table id="treatmentTable">
                ...
                <tbody>
                    <!-- Treatment rows will be inserted here by JavaScript -->
                </tbody>
            </table>
        </div>
    </div>
    ...
    <script src="../script/odontogram.js"></script>
    <script>
        // Show notification when "Other" treatment is selected
        function showOtherInput() {
            const treatmentSelect = document.getElementById("treatment");
            const otherTreatmentGroup = document.getElementById("other-treatment-group");

            if (treatmentSelect.value === "Other") {
                otherTreatmentGroup.style.display = "block";

                // SweetAlert notification for "Other" treatment selection
                Swal.fire({
                    toast: true,
                    position: 'top-end',
                    icon: 'info',
                    title: 'Please specify the other treatment',
                    showConfirmButton: false,
                    timer: 3000
                });
            } else {
                otherTreatmentGroup.style.display = "none";
                document.getElementById("other-treatment").value = ""; // Clear the input field
            }
        }
